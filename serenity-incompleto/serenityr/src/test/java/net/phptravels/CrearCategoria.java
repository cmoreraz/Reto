...
import net.phptravels.actions.CategoriaBlog;
import net.phptravels.actions.CategoriaPersonalizada;
import net.phptravels.actions.Decidido;
import net.phptravels.actions.IngresarCon;
import net.phptravels.actions.SeleccionarMenu;
...
public class CrearCategoria {
	...
	public void ingresarAMyAccountCorrectamente() {
		...
		actor.attemptsTo( SeleccionarMenu.blog() );  
		actor.attemptsTo( CategoriaBlog.add() );
